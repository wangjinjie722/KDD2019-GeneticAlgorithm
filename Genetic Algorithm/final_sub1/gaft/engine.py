...
class GAEngine(object):
        ...
        try:
            for g in range(ng):
                ...
                for _ in range(local_size):
                    ...
                    while not self.is_qualified(children):
    ...
    def is_qualified(self, children):
        child1 = children[0]
        child2 = children[1]
        ...
        def helper(child, valid_actions):
        ...
        return helper(child1, valid_actions) and helper(child2, valid_actions)
